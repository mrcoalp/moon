...
public:
    ...
    static void Info(const std::string& message) { s_callback(Level::Info, message); }

    /// Warning log.
    /// \param message Message to log.
    static void Warning(const std::string& message) { s_callback(Level::Warning, message); }

    /// Error log.
    /// \param message Message to log.
    static void Error(const std::string& message) { s_callback(Level::Error, message); }
